...
__global__ void kernelAdd(TYPE* A, TYPE* B)
{
	...
	TYPE a_val = A[i];
	TYPE b_val = B[i];
	repeat4096(a_val = b_val + operand; b_val = a_val + operand;);
	B[i] = b_val;
	A[i] = a_val;
}
...
__global__ void kernelDiv(TYPE* A, TYPE* B, TYPE* C, TYPE *D, TYPE operand)
{
	...
	TYPE a_val = A[i];
	TYPE b_val = B[i];
	repeat512(a_val = b_val / operand; b_val = a_val / operand;);
	B[i] = b_val;
	A[i] = a_val;
}
...
__global__ void kernelMAD(TYPE* A, TYPE* B, TYPE* C, TYPE *D, TYPE operand)
{
	...
	TYPE a_val = A[i];
	TYPE b_val = B[i];
	repeat4096(a_val = b_val * operand; a_val = b_val + operand; b_val = a_val * operand; b_val = a_val + operand;);
	B[i] = b_val;
	A[i] = a_val;
}
...
__global__ void kernelVectorAdd(TYPE* A, TYPE* B, TYPE* C, TYPE *D, TYPE operand)
{
	...
	TYPE a_val = A[i];
	TYPE b_val = B[i];
	repeat2048(a_val = a_val + b_val + operand; b_val = a_val + b_val + operand;);
	B[i] = b_val;
	A[i] = a_val;
}
...
__global__ void kernelRemainder(TYPE* A, TYPE* B, TYPE* C, TYPE *D, TYPE operand)
{
	...
	TYPE a_val = A[i];
	TYPE b_val = B[i];
	repeat256(a_val = b_val % operand; b_val = a_val % operand;);
	B[i] = b_val;
	A[i] = a_val;
}
...
__global__ void kernelAnd(int* A, int* B, int* C, int *D, int operand)
{
	...
	TYPE a_val = A[i];
	TYPE b_val = B[i];
	repeat4096(a_val = b_val & operand; b_val = a_val & b_val;);
	B[i] = b_val;
	A[i] = a_val;
}
