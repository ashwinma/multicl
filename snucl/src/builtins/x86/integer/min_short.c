...
uchar2 min(uchar2 x, short y){
	uchar2 rst;
	rst.v[0]=(x.v[0]<y)? x.v[0]:y;
	rst.v[1]=(x.v[1]<y)? x.v[1]:y;
  return rst;
}
uchar3 min(uchar3 x, short y){
	uchar3 rst;
	rst.v[0]=(x.v[0]<y)? x.v[0]:y;
	rst.v[1]=(x.v[1]<y)? x.v[1]:y;
...
uchar2 min(uchar2 x, ushort y){
	uchar2 rst;
	rst.v[0]=(x.v[0]<y)? x.v[0]:y;
	rst.v[1]=(x.v[1]<y)? x.v[1]:y;
  return rst;
}
uchar3 min(uchar3 x, ushort y){
	uchar3 rst;
	rst.v[0]=(x.v[0]<y)? x.v[0]:y;
	rst.v[1]=(x.v[1]<y)? x.v[1]:y;
	rst.v[2]=(x.v[2]<y)? x.v[2]:y;
...
uchar16 min(uchar16 x, ushort y){
	uchar16 rst;
	rst.v[0]=(x.v[0]<y)? x.v[0]:y;
	rst.v[1]=(x.v[1]<y)? x.v[1]:y;
	rst.v[2]=(x.v[2]<y)? x.v[2]:y;
