...
void MPI_Recv_C (void* buff, int count, MPI_Fint datatype, int src, int
tag, MPI_Fint comm, MPI_Fint *ierr) 
{
    *ierr = MPI_Recv(buff, count, MPI_Type_f2c(datatype), src, tag,
    MPI_Comm_f2c(comm));
}
*/
...
void MPIX_Send_C (int buff_id, int count, MPI_Fint *datatype, int dest, int
        tag, MPI_Fint *comm, MPI_Fint *ierr) 
{
//    *ierr = MPIX_Send((void*)getDevicePointer(buff_id), count, MPI_Type_f2c(*datatype), dest, tag,MPI_Comm_f2c(*comm), MPIX_GPU_CUDA, 0, NULL, NULL, NULL, NULL );
}
...
tag, MPI_Fint *comm, MPI_Fint *f_status, MPI_Fint *ierr) 
{
  /*  MPI_Status c_status;
    ...
    *ierr = MPIX_Recv((float*)getDevicePointer(buff_id), count, MPI_Type_f2c(*datatype), src, tag, MPI_Comm_f2c(*comm), &c_status, MPIX_GPU_CUDA, 0, NULL, NULL, NULL, NULL );
...
tag, MPI_Fint *comm, MPI_Fint *f_status, MPI_Fint *ierr) 
{
  /*  MPI_Status c_status;
    MPI_Status_f2c(f_status, &c_status);
    *ierr = MPIX_Recv((float*)getDevicePointer(buff_id), count, MPI_Type_f2c(*datatype), src, tag, MPI_Comm_f2c(*comm), MPI_STATUS_IGNORE, MPIX_GPU_CUDA, 0, NULL, NULL, NULL, NULL );
    MPI_Status_c2f(&c_status, f_status);
*/
}
...
void MPIX_Send_offset_C (int buff_id, int offset, int count, MPI_Fint *datatype, int dest, int
        tag, MPI_Fint *comm, MPI_Fint *ierr) 
{
    //*ierr = MPIX_Send(((float*)getDevicePointer(buff_id)) + offset, count, MPI_Type_f2c(*datatype), dest, tag,MPI_Comm_f2c(*comm), MPIX_GPU_CUDA, 0, NULL, NULL, NULL, NULL );
}
...
tag, MPI_Fint *comm, MPI_Fint *f_status, MPI_Fint *ierr) 
{
    /*MPI_Status c_status;
    MPI_Status_f2c(f_status, &c_status);
    *ierr = MPIX_Recv(((float*)getDevicePointer(buff_id)) + offset, count, MPI_Type_f2c(*datatype), src, tag, MPI_Comm_f2c(*comm), &c_status, MPIX_GPU_CUDA, 0, NULL, NULL, NULL, NULL );
    MPI_Status_c2f(&c_status, f_status);
*/
}
...
tag, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr) 
{
  /*  MPI_Request request_C = MPI_Request_f2c(*request);
    //*ierr = MPI_Isend(buff_id, count, MPI_Type_f2c(*datatype), dest, tag,MPI_Comm_f2c(*comm), &request_C);
    *ierr = MPIX_Isend(getDevicePointer(buff_id), count, MPI_Type_f2c(*datatype), dest, tag,MPI_Comm_f2c(*comm), &request_C, MPIX_GPU_CUDA, 0, NULL, NULL, NULL, NULL );
...
tag, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr) 
{
    ...
    *ierr = MPIX_Irecv(getDevicePointer(buff_id), count, MPI_Type_f2c(*datatype), src, tag, MPI_Comm_f2c(*comm), &request_C, MPIX_GPU_CUDA, 0, NULL, NULL, NULL, NULL );
    *request = MPI_Request_c2f(request_C);
*/
}
...
tag, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr) 
{
  /*  MPI_Request request_C = MPI_Request_f2c(*request);
    //*ierr = MPI_Irecv(buff_id, count, MPI_Type_f2c(*datatype), src, tag, MPI_Comm_f2c(*comm), &request_C);
    *ierr = MPIX_Irecv(buff, count, MPI_Type_f2c(*datatype), src, tag, MPI_Comm_f2c(*comm), &request_C, MPIX_TEST_BUF, 0, NULL, NULL, NULL, NULL );
    *request = MPI_Request_c2f(request_C);
*/
}
