...
class Atom {
 public:
  ...
  MMD_float3 *vold;
  MMD_float mass;
  cOpenCLData<MMD_float3, MMD_float3, xx>* d_x;
  cOpenCLData<MMD_float3, MMD_float3, xx>* d_v;
  cOpenCLData<MMD_float3, MMD_float3, xx>* d_f;
  cOpenCLData<MMD_float3, MMD_float3, xx>* d_vold;
