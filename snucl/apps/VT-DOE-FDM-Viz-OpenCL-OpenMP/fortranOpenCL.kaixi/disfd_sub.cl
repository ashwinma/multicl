					  ...
					  __global float *v1zM)
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_vel[2];
	i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd1_vel[8];
					   ...
					   __global float *v2zM)
{
	...
	i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd2_vel[8];
...
// implicit NONE
	...
	j  = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_vel[0];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
				...
				__global float *v1z_pyM)
{
	...
	lb = get_local_size(0) * get_group_id(0) + get_local_id(0) + lby0;
	i  = get_local_size(1) * get_group_id(1) + get_local_id(1) + nd1_vel[6];
				 ...
				 __global float *v2z_pxM)
{
	...
	j  = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_vel[0];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
				 ...
				 __global float *v2z_pyM)
{
	...
	lb = get_group_id(0) * get_local_size(0) + get_local_id(0) + lby0;
	i  = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd2_vel[6];
					   ...
					   __global float *v1zM)
{
    ...
    j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_tyy[2];
    i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd1_tyy[8];
...
//	float tfr4=1./528./ca;
    ...
    j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_tyz[2];
    i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd1_tyz[8];
...
//        rti,damp2,damp1,cl,sm2,pm,et,et1,wtp,wts
{
    ...
    j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_tyy[0];
    lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
...
//        rti,damp2,damp1,cl,sm2,pm,et,et1,wtp,wts
{
	...
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_tyy[6];
...
// real:: taoxy,cusxy,qxy,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_txy[0];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
...
//real:: taoxy,cusyx,qxy,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	//if(lby[0] > lby[1]) return;
	//if( lby(1)>lby(2) ) return
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_txy[6];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lby0;
...
//real:: taoxz,cusxz,dvxz,qxz,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_txz[0];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
...
//implicit NONE
{
	...
	//if (lby[0] > lby[1]) return;
	//if( lby(1)>lby(2) ) return
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_txz[8];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lby0;
...
//real:: taoyz,cusyz,dvyz,qyz,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	//if(lby[0] > lby[1]) return;
	//if( lby(1)>lby(2) ) return
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd1_tyz[6];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lby0;
...
//        cl,sm2,et,et1,dmws,pm,wtp,wts
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_tyy[2];
	i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd2_tyy[8];
...
//real:: qxz,qyz,cusxz,cusyz,sm,et,et1,dmws
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_tyz[2];
	i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd2_tyz[8];
...
//       rti,damp2,damp1,cl,sm2,pm,et,et1,wtp,wts
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_tyy[0];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
...
//       rti,damp2,damp1,cl,sm2,pm,et,et1,wtp,wts
{
	...
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_tyy[6];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lby0;
...
//       damp2,damp1,cl,sm2,pm,et,et1,wtp,wts
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_tyy[0];
	i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd2_tyy[6];
...
//real:: taoxy,cusxy,qxy,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_txy[0];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
...
//real:: taoxy,cusxy,qxy,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_txy[6];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lby0;
...
//real:: cusxy,qxy,sm,dmws,et,et1
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_txy[2];
	i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd2_txy[8];
...
//real:: taoxz,cusxz,qxz,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_txz[0];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lbx0;
...
//real:: dvxz,dvzx,cusxz,qxz,sm,dmws,et,et1
{
	...
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_txz[8];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lby0;
...
//real:: taoxz,cusxz,qxz,damp2,damp1,sm,dmws,et,et1
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_txz[0];
	i = get_group_id(1) * get_local_size(1) + get_local_id(1) + nd2_txz[6];
...
//real:: taoyz,cusyz,qyz,rth,damp2,damp1,sm,dmws,et,et1
{
	...
	//if(lby[0] > lby[1]) return;
	//if( lby(1)>lby(2) ) return
	i = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_tyz[6];
	lb = get_group_id(1) * get_local_size(1) + get_local_id(1) + lby0;
...
//real:: taoyz,cusyz,qyz,damp2,damp1,sm,dmws,et,et1
{
	...
	j = get_group_id(0) * get_local_size(0) + get_local_id(0) + nd2_tyz[0];
