...
ushort2 select(ushort2 a, ushort2 b, ushort2 c) {
...
ushort3 select(ushort3 a, ushort3 b, ushort3 c) {
...
ushort4 select(ushort4 a, ushort4 b, ushort4 c) {
...
ushort8 select(ushort8 a, ushort8 b, ushort8 c) {
...
ushort16 select(ushort16 a, ushort16 b, ushort16 c) {
