...
schar select(schar a, schar b, uchar c) {
	return	c ? b : a;
}

char2 select(char2 a, char2 b, uchar2 c) {
...
char3 select(char3 a, char3 b, uchar3 c) {
...
char4 select(char4 a, char4 b, uchar4 c) {
...
char8 select(char8 a, char8 b, uchar8 c) {
...
char16 select(char16 a, char16 b, uchar16 c) {
