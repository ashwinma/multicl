...
void compute_velocityCm( int *nztop,  int *nztm1,  float *ca, int *lbx,
...
//stress computation----------------------------------------------
void compute_stressCm(int *nxb1, int *nyb1, int *nx1p1, int *ny1p1, int *nxtop, int *nytop, int *nztop, int *mw1_pml,
