...
! call MPI_INIT( ierr )
! write(*,*) "fortran: call mpi_init"
 call MPI_INIT( ierr )
! call MPI_Init_C( ierr )
! write(*,*) "fortran: call mpi_comm_rank"
 call MPI_COMM_RANK( MPI_COMM_WORLD, myid_world,  ierr )
! write(*,*) "fortran: call mpi_comm_size"
...
! call subroutine input_fd_praram
! write(*,*) "fortran: call subroutine input_fd_param"
 call input_fd_param(myid_world,comm_world,nproc_world,fileInp)
 call MPI_Barrier(comm_world, ierr)
! write(*,*) ' after call input_fd_param'
! write(*,*) "fortran: call subroutine run_fd_simul"
 call run_fd_simul(myid_world)
 call MPI_Barrier(comm_world, ierr)
! write(*,*) "fortran: after calling subroutine run_fd_simul"
...
!     end subroutine data_cpy_d2h_outputsC
     ...
     subroutine compute_velocityCm(nztop, nztm1, ca, lbx, lby, nd1_vel, cptr_rho, &
                            ...
                            nybtm, nzbtm, myid) bind(c, name='compute_velocityCm') 
       use mpi
       use, intrinsic :: iso_c_binding, ONLY: C_INT, C_FLOAT, C_PTR
       integer(c_int), intent(in) :: nztop
     ...
     end subroutine compute_velocityCm

    !  subroutine compute_stressCm(nxb1, nyb1, nx1p1, ny1p1, nxtop, nytop, nztop, mw1_pml, mw1_pml1, &
    ...
    !                cptr_qt2yz_pz, cptr_qt2zz_pz, cptr_v2x, cptr_v2y, cptr_v2z, myid) bind(c, name='compute_stressCm')
    !    use mpi
    !    use, intrinsic :: iso_c_binding, ONLY: C_INT, C_FLOAT, C_PTR
...
! include 'copy_outputs_to_gpu.h'
   ...
   do ntprt=1,npt_out
   do inne=1,intprt
     ! write(*,*) "Iteration : ", (ntprt-1)*intprt + inne
...
!    include 'copy_outputs_from_gpu.h'
     ...
     ! write(*,*) "fortran: call subroutine compute_velocityC"
     include 'call_computevelocitycm.h'
     call record_time(tend)
     write(*,*) "TIME Velocity Computation :", tend-tstart
! include 'copy_outputs_to_gpu.h'

     call record_time(tstart)
! some values may change by calling the following function
...
! some values may change by calling the following function
     ...
     call record_time(tstart)
     ! write(*,*) "fortran: call subroutine compute_stressC and compute_stressCDebug"
     include 'call_computestresscm.h'
     call record_time(tend)
