...
!
    subroutine MPIX_ISEND_C (buf_id, n, datatype, dest, tag, comm, req, ierr)&
    ...
    subroutine MPIX_IRECV_C (buf_id, n, datatype, src, tag, comm, req, ierr)&
    ...
    subroutine MPIX_SEND_C (buf_id, n, datatype, dest, tag, comm, ierr)&
    ...
    subroutine MPIX_RECV_C (buf_id, n, datatype, src, tag, comm, status, ierr)&
    ...
    subroutine MPIX_SEND_offset_C (buf_id, offset, n, datatype, dest, tag, comm, ierr)&
    ...
    subroutine MPIX_RECV_offset_C (buf_id,offset, n, datatype, src, tag, comm, status, ierr)&
