...
class Neighbor {
 ...
 private:
  ...
  cOpenCLData<int, int, xx>* d_bincount;
  int *bins;                       // ptr to next atom in each bin
  cOpenCLData<int, int, xx>* d_bins;
  int *ibins;                       // ptr to next atom in each bin
  cOpenCLData<int, int, xx>* d_ibins;
  int atoms_per_bin;

  int nstencil;                    // # of bins in stencil
  int *stencil;                    // stencil list of bin offsets
  cOpenCLData<int, int, xx>* d_stencil;
