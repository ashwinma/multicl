...
#ifdef USE_CPU
#define COPY_FACES1_DIM     COPY_FACES1_DIM_CPU
#define COPY_FACES2_DIM     COPY_FACES2_DIM_CPU
#define COPY_FACES3_DIM     COPY_FACES3_DIM_CPU
#define COPY_FACES4_DIM     COPY_FACES4_DIM_CPU
#define COPY_FACES5_DIM     COPY_FACES5_DIM_CPU
#define COPY_FACES6_DIM     COPY_FACES6_DIM_CPU
...
#define X_SOLVE6_DIM        X_SOLVE6_DIM_CPU
#define PINVR_DIM           PINVR_DIM_CPU
#define Y_SOLVE6_DIM        Y_SOLVE6_DIM_CPU
#define TZETAR_DIM          TZETAR_DIM_CPU
#define Z_SOLVE6_DIM        Z_SOLVE6_DIM_CPU
#define ADD_DIM             ADD_DIM_CPU

#else //GPU
#define COPY_FACES1_DIM     COPY_FACES1_DIM_GPU
#define COPY_FACES2_DIM     COPY_FACES2_DIM_GPU
#define COPY_FACES3_DIM     COPY_FACES3_DIM_GPU
#define COPY_FACES4_DIM     COPY_FACES4_DIM_GPU
#define COPY_FACES5_DIM     COPY_FACES5_DIM_GPU
#define COPY_FACES6_DIM     COPY_FACES6_DIM_GPU
...
#define X_SOLVE6_DIM        X_SOLVE6_DIM_GPU
#define PINVR_DIM           PINVR_DIM_GPU
#define Y_SOLVE6_DIM        Y_SOLVE6_DIM_GPU
#define TZETAR_DIM          TZETAR_DIM_GPU
#define Z_SOLVE6_DIM        Z_SOLVE6_DIM_GPU
